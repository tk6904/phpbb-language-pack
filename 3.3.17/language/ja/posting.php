...
$lang = array_merge($lang, array(
	...
	'ATTACH_COMMENT_NO_EMOJIS'	=> '添付コメントには禁止文字（絵文字）が含まれています',
	...
	'DELETE_POST_CONFIRM'			=> 'この記事を削除してもよろしいですか？',
	'DELETE_POST_PERMANENTLY_CONFIRM'	=> 'この記事を<strong>完全に</strong>削除してもよろしいですか？',
	'DELETE_POST_PERMANENTLY'	=> array(
		1	=> '%1$d 件の記事を完全に削除しました。復元は出来ません。',
	),
	'DELETE_POSTS_CONFIRM'		=> 'これらの記事を削除してもよろしいですか？',
	'DELETE_POSTS_PERMANENTLY_CONFIRM'	=> 'これらの記事を<strong>完全に</strong>削除してもよろしいですか？',
	'DELETE_REASON'				=> '削除の理由',
	'DELETE_REASON_EXPLAIN'			=> '削除理由はモデレーターが閲覧可能となります',
	'DELETE_POST_WARN'			=> '一度削除された記事を元に戻すことはできません',
	'DELETE_TOPIC_CONFIRM'			=> 'このトピックを削除してもよろしいですか？',
	'DELETE_TOPIC_PERMANENTLY'		=> array(
		1	=> '%1$d 件のトピックを完全に削除しました。復元は出来ません。',
	),
	'DELETE_TOPIC_PERMANENTLY_CONFIRM'	=> 'このトピックを<strong>完全に</strong>削除してもよろしいですか？',
	'DELETE_TOPICS_CONFIRM'			=> 'これらのトピックを削除してもよろしいですか？',
	'DELETE_TOPICS_PERMANENTLY_CONFIRM'	=> 'これらのトピックを<strong>完全に</strong>削除してもよろしいですか？',
	...
	'LOGIN_EXPLAIN_SOFT_DELETE'	=> 'このフォーラム内の投稿をソフトデリートするにはログインが必要です',
	...
	'MAX_ATTACHMENT_FILESIZE'	=> '添付ファイルの最大サイズは %s です',
	...
	'MAX_IMG_HEIGHT_EXCEEDED'	=> array(
		1	=> '使用できる画像ファイルの最大サイズ（高さ）は %1$d pix です',
	),
	...
	'MESSAGE_BODY_EXPLAIN'		=> array(
		...
		1	=> 'メッセージを入力してください。<strong>%d</strong> 字まで入力できます。',
	),
	...
	'NO_TEMP_DIR'			=> '一時フォルダが見つからないか、書き込み可能ではありません。',

	'PARTIAL_UPLOAD'		=> 'ファイルは一部だけアップロードされました',
	'PHP_UPLOAD_STOPPED'		=> 'PHPがファイルアップロードを中止しました',
...
',
	...
	'POLL_OPTIONS_EXPLAIN'		=> array(
		1	=> '１行につき１つのオプションを入力してください。最大 <strong>%d</strong> 個までオプションを作成できます。',
	),
	'POLL_OPTIONS_EDIT_EXPLAIN'		=> array(
		1	=> '１行につき１つのオプションを入力してください。最大 <strong>%d</strong> 個までオプションを作成できます。オプションを削除または追加した場合、投票結果は全てリセットされます。',
	),
	'POLL_QUESTION'			=> '投票のお題',
	...
	'QUOTE_NO_NESTING'		=> '入れ子になっている引用を埋め込むことができません',

	'REMOTE_UPLOAD_TIMEOUT'		=> 'リクエストがタイムアウトとなったため、ファイルがアップロードできませんでした',
	'SAVE'				=> 'セーブ',
	'SAVE_DATE'			=> 'セーブした日付',
	'SAVE_DRAFT'			=> '下書きのセーブ',
	...
	'UNSUPPORTED_CHARACTERS_MESSAGE'	=> 'メッセージには下記のサポートされていない文字が含まれています:<br />%s',
	'UNSUPPORTED_CHARACTERS_SUBJECT'	=> 'タイトルには下記のサポートされていない文字が含まれています:<br />%s',
	...
	'WRONG_SIZE'			=> '画像サイズ （横幅 ｘ 高さ、単位は pix) を最小 %1$s x %2$s から最大 %3$s x %4$s の間にする必要があります。アップロードされた画像のサイズは %5$s x %6$s です。',
