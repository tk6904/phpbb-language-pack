...
$lang = array_merge($lang, array(
	...
	'ACP_CAT_USERS'			=> 'ユーザー',
	'ACP_CLIENT_COMMUNICATION'	=> 'クライアントコミュニケーション',
	'ACP_COOKIE_SETTINGS'		=> 'cookie 設定',
	'ACP_CONTACT'			=> 'お問い合わせページ',
	'ACP_CONTACT_SETTINGS'		=> 'お問い合わせページ設定',
	...
	'ACP_EXTENSION_MANAGEMENT'	=> '拡張モジュール管理',
	'ACP_EXTENSIONS'		=> '拡張モジュールの管理',
	...
	'ACP_GROUPS_POSITION'			=> 'グループポジションの管理',

	'ACP_HELP_PHPBB'			=> 'phpBB の開発支援',
	...
	'ACP_LOAD_SETTINGS'		=> 'サーバ負荷設定',
	'ACP_LOGGING'			=> 'ログ',

	'ACP_MAIN'				=> 'ACP index',

	'ACP_MANAGE_ATTACHMENTS'		=> '添付ファイルの管理',
	'ACP_MANAGE_ATTACHMENTS_EXPLAIN'	=> 'ここでは記事とプライベートメッセージに添付したファイルを参照したり削除したりすることができます',
	...
	'CONTAINER_EXCEPTION' 		=> 'インストール済みの拡張モジュールの影響のため、コンテナ構築エラーが発生しました。このため、全ての拡張モジュールが一時的に無効になりました。フォーラムキャッシュの消去を試みてください。全ての拡張モジュールは、コンテナエラーが解決されれば自動的に再有効化されます。このエラーが継続する場合は、<a href="https://www.phpbb.com/support">phpBB.com</a> にアクセスしてサポートを受けてください。',
	'EXCEPTION' 			=> '例外',

	'COLOUR_SWATCH'			=> '色のサンプル',
	'CONFIG_UPDATED'		=> '設定の更新に成功しました',
	'CRON_LOCK_ERROR'		=> 'cron lock が獲得できません',
	'CRON_NO_SUCH_TASK'		=> 'cron タスク“%s”が見つかりません',
	'CRON_NO_TASK'			=> '現在、走らせる必要がある cron タスクはありません',
	'CRON_NO_TASKS'			=> 'cron タスクは見つかりませんでした',
	'CSV_INVALID'			=> '指定されたコンマ区切りの設定 “%1$s” は無効です。値はコンマのみで区切る必要があり、先頭または末尾の区切り文字を含めることはできません。',
	...
	'LOAD_NOTIFICATIONS'		=> '通知の表示',
	'LOAD_NOTIFICATIONS_EXPLAIN'	=> '通知一覧を全ページに表示します（一般的にはヘッダー部分）',
	'LOGGED_IN_AS'			=> 'ログイン名：',
	...
	'NO_FILES_TO_DELETE'		=> '選択した添付ファイルは存在しません',
	...
	'RELEASE_ANNOUNCEMENT'		=> '告知',
	'REMIND'			=> 'アカウント有効化メールの送信',
	'REPARSE_LOCK_ERROR'		=> '再パースはすでに別のプロセスによって進行中です',
	'RESYNC'			=> '再同期',

	'RUNNING_TASK'			=> '稼働中のタスク: %s',
	...
	'TASKS_NOT_READY'		=> '待機していないタスク:',
	'TASKS_READY'			=> '待機中のタスク:',
	'TOTAL_SIZE'			=> '全体サイズ',

	'UCP'					=> 'ユーザーCP',
	'URL_INVALID'			=> '設定 “%1$s” に指定されたURLは無効です。',
	'URL_SCHEME_INVALID'	=> 'コンマ区切りの設定 “%1$s” で指定されたスキーム “%2$s” は無効です。スキームはラテン文字で始まり、その後に英数字、ハイフン、またはドットが続く必要があります。',
	'USERNAMES_EXPLAIN'		=> '１行につき１つのユーザー名を入力してください',
	'USER_CONTROL_PANEL'	=> 'ユーザーCP',

	'UPDATE_NEEDED'			=> '掲示板バージョンが更新されていません',
	'UPDATE_NOT_NEEDED'		=> '掲示板バージョンは最新です',
	'UPDATES_AVAILABLE'		=> '更新版が提供されています:',
...
// PHP info
$lang = array_merge($lang, array(
	'ACP_PHP_INFO_EXPLAIN'	=> 'ここではサーバにインストールされている PHP の設定情報 (php.ini) を確認できます。設定情報には拡張モジュール、利用可能な変数、デフォルト設定の詳細が含まれています。これらの情報はサイトに何か問題が生じた場合、その問題を診断する時に役立つはずです。ホスティングサービスを利用している場合、サーバ運営会社によってはセキュリティ上の理由で表示される情報が制限されている可能性があります。www.phpbb.com のサポートフォーラムの<a href="https://www.phpbb.com/about/team/">オフィシャルチームメンバー</a>に質問する時以外はこのページにおけるいかなる情報も口外すべきではない事を忠告しておきます。',
...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> '<var>mbstring.http_input</var> は空欄にしてください。現在の値は、<samp>PHP情報</samp> のページで確認できます。',
	'ERROR_MBSTRING_HTTP_OUTPUT'					=> 'HTTP出力文字エンコーディングの自動変換 の値が不適切です',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'			=> '<var>mbstring.http_output</var> は空欄にしてください。現在の値は、<samp>PHP情報</samp>のページで確認できます。',
	'ERROR_DEFAULT_CHARSET'							=> 'デフォルトの文字セットが不適切に設定されています',
	'ERROR_DEFAULT_CHARSET_EXPLAIN'					=> '<var>default_charset</var>には<samp>UTF-8</samp>を設定する必要があります。現在の値は、<samp>PHP情報</samp>のページで確認できます。',
	...
	'NO_SEARCH_INDEX'	=> '選択した検索バックエンドには検索インデックスがありません。<br />インデックスを生成してください for “%1$s” in %2$s検索インデックス%3$s セクション',
	...
	'PHP_VERSION_OLD'	=> 'サーバにインストールされている PHP のバージョン (%1$s) は将来的に phpBB のサポート外となります。最低限必要なバージョンは PHP %2$s です。 %3$s詳しくはこちら%4$s',
	...
	'PURGE_CACHE_SUCCESS'	=> 'キャッシュデータは消去されました',
	...
	'RESYNC_POSTCOUNTS_SUCCESS'		=> '記事数を再同期しました',
	...
	'RESYNC_POST_MARKING_SUCCESS'	=> 'トピックの投稿マークを再同期しました',
	'RESYNC_STATS'				=> '統計の同期',
	'RESYNC_STATS_CONFIRM'			=> '統計データを本当に同期してもよろしいですか？',
	'RESYNC_STATS_EXPLAIN'			=> '全返信数、全トピック数、全ユーザー数、全添付ファイル数を再計算します',
	'RESYNC_STATS_SUCCESS'			=> '統計データを再同期しました',
	'RUN'					=> '実行',

	'STATISTIC'				=> '統計',
	'STATISTIC_RESYNC_OPTIONS'	=> '統計データの 同期／リセット',

	'TIMEZONE_INVALID'	=> '選択したタイムゾーンが有効ではありません',
	'TIMEZONE_SELECTED'	=> '（選択中のタイムゾーン）',
	...
	'VERSION_CHECK_EXPLAIN'			=> 'phpBBが更新インストールされているか確認します',
	'VERSIONCHECK_INVALID_ENTRY'		=> '最新バージョン情報はサポート対象外のエントリーを含んでいます',
	'VERSIONCHECK_INVALID_URL'		=> '最新バージョン情報は不明なURLを含んでいます',
	'VERSIONCHECK_INVALID_VERSION'		=> '最新バージョン情報は不明なバージョン情報を含んでいます',
	'VERSION_NOT_UP_TO_DATE_ACP'		=> 'あなたの phpBB は最新バージョンではありません。<br />下記は更新方法や詳細の情報を含む the release announcement のリンクです。',
	'VERSION_NOT_UP_TO_DATE_TITLE'		=> 'あなたの phpBB は最新バージョンではありません',
	'VERSION_UP_TO_DATE_ACP'		=> 'あなたの phpBB は最新バージョンです。現在アップデート情報はありません。',
...
$lang = array_merge($lang, array(
	...
	'SEND_STATISTICS'		=> 'サーバと掲示板の設定情報を提供',
	'SEND_STATISTICS_LONG'		=> 'サーバと掲示板の設定情報を phpBB Group に提供する',
	'SHOW_STATISTICS'		=> '提供情報を表示する',
	'THANKS_SEND_STATISTICS'	=> 'ご協力して頂きありがとうございました',
	'FAIL_SEND_STATISTICS'		=> '設定情報を送信できませんでした',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_ACL_ADD_USER_LOCAL_F_'			=> '<strong>フォーラムパーミッションを追加 or 変更しました - </strong> to %1$s<br />» %2$s',
	'LOG_ACL_ADD_USER_LOCAL_M_'			=> '<strong>モデレータパーミッションを追加 or 変更しました - </strong> to %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_F_'		=> '<strong>フォーラムパーミッションを追加 or 変更しました - </strong> to %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_M_'		=> '<strong>モデレータパーミッションを追加 or 変更しました - </strong> to %1$s<br />» %2$s',

	'LOG_ACL_ADD_MOD_LOCAL_M_'			=> '<strong>モデレータパーミッションを追加 or 変更しました - </strong> for %1$s<br />» %2$s',
	'LOG_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>フォーラムパーミッションを追加 or 変更しました - </strong> for %1$s<br />» %2$s',
	...
	'LOG_BBCODE_CONFIGURATION_ERROR'	=> '<strong>BBCodeの設定中にエラーが発生しました</strong>: %1$s<br />» %2$s',
	...
	'LOG_CONFIG_LOAD'			=> '<strong>サーバ負荷設定 を変更しました</strong>',
	...
	'LOG_DELETE_POST'			=> '<strong>次の理由で記事“%1$s”を削除しました</strong><br />» written by %2$s <br />» %3$s',
	'LOG_DELETE_SHADOW_TOPIC'		=> '<strong>シャドウトピックを削除しました</strong><br />» %s',
	'LOG_DELETE_TOPIC'			=> '<strong>次の理由でトピック“%1$s”を削除しました</strong><br />» written by %2$s <br />» %3$s',
	...
	'LOG_POST_DISAPPROVED'			=> '<strong>次の理由で“%3$s”の記事 “%1$s” を承認しませんでした</strong><br />» %2$s',
	'LOG_POST_EDITED'			=> '<strong>次の理由で記事 “%1$s” を編集しました</strong><br />» written by %2$s <br />» %3$s',
	...
	'LOG_RESTORE_TOPIC'			=> '<strong>トピック“%1$s”を復元しました written by</strong><br />» %2$s',
	'LOG_SOFTDELETE_POST'			=> '<strong>次の理由で“%2$s”の記事“%1$s”を削除しました</strong><br />» %3$s',
	'LOG_SOFTDELETE_TOPIC'			=> '<strong>次の理由で“%2$s”のトピック“%1$s”を削除しました</strong><br />» %3$s',
	...
	'LOG_TOPIC_DISAPPROVED'		=> '<strong>次の理由でトピック “%1$s” を承認しませんでした</strong><br />» written by %3$s <br />» %2$s',
	...
	'LOG_VERSION_CHECK_FAIL'	=> '<strong>バージョンチェックに失敗しました</strong>',
	...
	'LOG_ERROR_CAPTCHA'		=> '<strong>CAPTCHA エラー</strong><br />» %s',
	...
	'LOG_PLUPLOAD_TIDY_FAILED'		=> '<strong>大きなファイルのため %1$s を開けませんでした。パーミッションを確認してください。check permissions.</strong><br />例外: %2$s<br />トレース: %3$s', // tidyingの意味再確認
	...
	'LOG_AUTO_PRUNE'			=> '<strong>フォーラムを自動プルーニングしました</strong><br />» %s',
	'LOG_PRUNE_SHADOW'		=> '<strong>シャドウトピックを自動プルーニングしました</strong><br />» %s',
	...
	'LOG_RESYNC_FILES_STATS'	=> '<strong>再同期ファイルの統計データ</strong>',
	...
	'LOG_SPHINX_ERROR'			=> '<strong>Sphinx エラー</strong><br />» %s',

	'LOG_SPAMHAUS_OPEN_RESOLVER'	=> 'Spamhaus はオープンリゾルバを使用したクエリを許可していません。ブラックリストチェックは無効化されました。詳細は https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/ を参照してください。',
	'LOG_SPAMHAUS_VOLUME_LIMIT'		=> 'Spamhaus へのクエリ数の上限を超えました。ブラックリストチェックは無効化されました。詳細は https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/ を参照してください。',
	...
	'LOG_WARNINGS_DELETED'		=> array(
		1 => '<strong>%2$d 個のユーザーの警告を削除しました</strong><br />» %1$s', // Example: '<strong>Deleted 2 user warnings</strong><br />» username'
	),
	...
	'LOG_EXT_ENABLE'	=> '<strong>拡張モジュールを有効にしました</strong><br />» %s',
	'LOG_EXT_DISABLE'	=> '<strong>拡張モジュールを無効にしました</strong><br />» %s',
	'LOG_EXT_PURGE'		=> '<strong>拡張モジュールのデータを削除しました</strong><br />» %s',
	'LOG_EXT_UPDATE'	=> '<strong>拡張モジュールを更新しました</strong><br />» %s',
));
