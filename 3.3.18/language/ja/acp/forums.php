...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_SHADOW_FREQ'		=> 'シャドウトピックの自動プルーニング頻度',
	'AUTO_PRUNE_SHADOW_DAYS'		=> 'シャドウトピックの閲覧寿命',
	'AUTO_PRUNE_SHADOW_DAYS_EXPLAIN'	=> 'シャドウトピックが生存し続ける、最終移動日からの日数',
	'AUTO_PRUNE_SHADOW_FREQ_EXPLAIN'	=> 'この日数が経つ毎にシャドウトピックのプルーニング（一括削除）が実行されます',
	...
	'ENABLE_INDEXING_EXPLAIN'		=> ' “はい” にした場合、投稿した記事はインデックスされ検索されるようになります',
	...
	'FORUM_NAME_EMOJI'					=> '入力したフォーラム名は無効です。<br>以下のサポートされていない文字が含まれています：<br>%s',
	'FORUM_PARENT'						=> '親フォーラム',
	...
	'FORUM_PRUNE_SHADOW'				=> 'シャドウトピックを自動プルーニングする',
	'FORUM_PRUNE_SHADOW_EXPLAIN'			=> '閲覧頻度や寿命を設定してシャドウトピックの自動プルーニングを行います',
	...
	'LINK'					=> 'リンク',
	'LIMIT_SUBFORUMS'			=> '説明表示を直接の子サブフォーラムに限定する',
	'LIMIT_SUBFORUMS_EXPLAIN'	=> '表示するサブフォーラムを、現在のフォーラムの直接の子孫（子）であるサブフォーラムに制限します。これを無効にすると、深さに関係なく、「フォーラム説明の下にサブフォーラムリンクを表示する」オプションが有効になっているすべてのサブフォーラムが表示されます。',
