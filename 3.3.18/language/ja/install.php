...
現在の安定版であるphpBB3のフルサポートを無料で提供します。</p><ul><li>インストール</li><li>設定</li><li>技術的な質問</li><li>ソフトウェアの潜在的なバグに関する問題</li><li>Release Candidate (RC)バージョンから最新の安定バージョンへの更新</li><li>phpBB2. 0.x から phpBB3 への変換</li><li> 他のディスカッションボードソフトウェアから phpBB3 への変換（<a href="https://www.phpbb.com/community/viewforum.php?f=486">Convertors Forum</a>を参照してください）</li></ul><p>まだベータ版のphpBB3を使用しているユーザーには、最新版のインストールに置き換えることをお勧めします。 </p><h2>拡張機能/スタイル</h2><p>拡張機能に関する問題は、適切な<a href="https://www.phpbb.com/community/viewforum.php?f=451">Extensions Forum</a>.<br />スタイル、テンプレート、テーマに関する問題は、適切な<a href="https://www.phpbb.com/community/viewforum.php?f=471">Styles Forum</a>に投稿してください。<br /><br />特定のパッケージに関する質問の場合は、そのパッケージ専用のトピックに直接投稿してください。 </p><h2>サポートを受ける</h2><p><a href="https://www.phpbb.com/support/">サポートセクション</a><br /><a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/">クイックスタートガイド</a><br /><br />最新のニュースやリリース情報を入手するには、<a href="https://www.x.com/phpbb/">X</a>と<a href="https://www.facebook.com/phpbb/">Facebook</a>でフォローしてください。<br /><br />',
