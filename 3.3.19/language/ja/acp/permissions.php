...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>パーミッションの設定と管理についてのより詳しい説明が <a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/permissions/">Quick Start Guide : Chapter 1.5</a> に載っています。</p>		
	',

	'ACL_NEVER'				=> 'Never',
	'ACL_SET'				=> 'パーミッションの設定',
	'ACL_SET_EXPLAIN'		=> 'ユーザーまたはグループのパーミッションを設定するには、それぞれのユーザーまたはグループに対して パーミッションセットを与えるか カスタム設定でパーミッションオプションを個別に与える （“はい” にする） 必要があります。phpBB3 ではユーザーに対してもグループに対してもパーミッションを与えることができます。そうすると必然的にパーミッション設定値の衝突が起こります。パーミッション設定値 （<strong>はい</strong>、<strong>いいえ</strong>、<strong>NEVER</strong>） が衝突している状況について分かり易く説明するために、ユーザーＸ さんが グループＡ と グループＢ のメンバーである状況を例にして説明します。例１： あるパーミッションオプションが グループＡ で <strong>はい</strong> 、グループＢ で <strong>いいえ</strong> に設定されている場合、たとえ ユーザーＸ で <strong>いいえ</strong> に設定されていたとしても、ユーザーＸ はそのパーミッションの機能を<strong>使用できます</strong>。例２： あるパーミッションオプションが グループＡ で <strong>はい</strong>、グループＢ で <strong>NEVER</strong> に設定されている場合、たとえ ユーザーＸ で <strong>はい</strong> に設定されていたとしても、ユーザーＸ はそのパーミッションの機能を<strong>使用できません</strong>。つまり要約するとパーミッション設定値の優先順位は ユーザー ・ グループ に関係なく <strong>いいえ</strong> ＜ <strong>はい</strong> ＜ <strong>NEVER</strong> である、という事です。通常、 <strong>NEVER</strong> の使用はグループではなく個々のユーザーのみに控えた方が良いでしょう。複数のユーザーまたはグループに同じ設定をする場合、ユーザー名またはグループ名の隣にあるチェックボックスをチェックする事で設定をコピーできます。なお、創設者アカウントに対する管理者パーミッションの設定は効果がありません。創設者の管理者パーミッションは常に <strong>はい</strong> に設定されます。',
	'ACL_SETTING'			=> '設定値',
	...
	'NO_ROLE_ASSIGNED_EXPLAIN'	=> 'こちらを選択するとカスタム設定になります。未設定の状態にしたい場合は “全て <strong>いいえ</strong>” リンクをクリックして更新してください。',
