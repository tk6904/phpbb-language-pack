...
$lang = array_merge($lang, array(
	...
	'PRIVACY_POLICY'		=> 'このポリシーは “%1$s” とその関連団体 （以下 “私達”, “掲示板”, “当サイト”, “%1$s”, “%2$s”) さらには phpBB （以下 “phpBBソフトウェア”, “www.phpbb.com”, “phpBB Limited”, “phpBB Teams”) が、あなたが当サイトへアクセスすることによって発生した情報あるいはあなたが当サイトで入力し送信した情報 （以下 “あなたの情報”) をどのように利用するかを述べたものです。
	<br><br>
	...
	<br><br>
	当サイトへアクセスすることによって発生するあなたの情報の残りもう１つは、あなたが私達に送信するデータです。具体的には、ゲストユーザーとして投稿したデータ （以下 “ゲストの投稿記事”） 、“%1$s” にユーザー登録する際に送信したデータ （以下 “あなたのアカウント情報”） 、登録ユーザーとして投稿したデータ （以下 “あなたの投稿記事”) です。
	<br><br>
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ADDED'					=> 'ユーザー登録して頂きありがとうございます。アカウントは作成されました。',
	...
	'ACTIVATION_EMAIL_SENT'			=> '入力されたユーザー名とメールアドレスが正しい場合、そのアドレス宛てにアカウント有効化メールが送信されています。有効化メールは 24 時間に 1 通までしか送信できません。それでもアカウントを有効化できない場合は、管理人までご連絡ください。',
	'ACTIVATION_EMAIL_SENT_ADMIN'	=> '入力されたユーザー名とメールアドレスが正しい場合、管理人宛てにアカウント有効化の要請メールが送信されています。有効化メールは 24 時間に 1 通までしか送信できません。それでもアカウントを有効化できない場合は、管理人までご連絡ください。',
	'ADD'							=> '追加',
	'ADD_BCC'						=> '追加 [ BCC ]',
	...
	'ATTACHMENT_LOCKED'				=> 'トピックが閉鎖されているため、添付ファイルは削除できません',
	'AUTOLOGIN_SESSION_KEYS_DELETED'	=> '「自動ログインを有効にする」のログインキーの削除に成功しました',
	'AVATAR_CATEGORY'			=> 'カテゴリ',


	'AVATAR_DRIVER_GRAVATAR_TITLE'	=> 'Gravatar',
	'AVATAR_DRIVER_GRAVATAR_EXPLAIN'=> 'Gravatarは同一のアバターを複数のウェブサイトに表示させるためのサービスです。詳細は<a href="http://www.gravatar.com/">Gravatar公式サイト</a>を参照してください',
	'AVATAR_DRIVER_LOCAL_TITLE'		=> 'アバターギャラリー',
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> '保存されているアバター画像セット内から使用する画像を選択できます',
	'AVATAR_DRIVER_REMOTE_TITLE'	=> '外部サイトの画像をリンク',
	'AVATAR_DRIVER_REMOTE_EXPLAIN'	=> '別のウェブサイトにあるアバター画像をリンクします',
	'AVATAR_DRIVER_UPLOAD_TITLE'	=> 'アバターのアップロード',
	'AVATAR_DRIVER_UPLOAD_EXPLAIN'	=> '自身で作成したアバターをアップロードします',


	'AVATAR_EXPLAIN'		=> '使用できる最大サイズ： 横幅: %1$s px, 高さ: %2$s px, ファイルサイズ: %3$.2f KiB',
	'AVATAR_EXPLAIN_NO_FILESIZE'	=> '最大サイズ；横幅: %1$s, 高さ: %2$s',
	...
	'FIELD_INVALID_CHARS_ALPHA_DOTS'	=> 'フィールド “%s” の値は無効です。アルファベット・数字、または . のみ使用可能です。',
	'FIELD_INVALID_CHARS_ALPHA_ONLY'	=> 'フィールド “%s” の値は無効です。アルファベット・数字のみ使用可能です。',
	'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'フィールド “%s” の値は無効です。アルファベット・数字、または _,-. のみ使用可能で、先頭の文字はアルファベットにする必要があります。',
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> 'フィールド “%s” の値は無効です。アルファベット・数字・スペース、または -+_[] のみ使用可能です。',
	'FIELD_INVALID_CHARS_ALPHA_UNDERSCORE'	=> 'フィールド “%s” の値は無効です。アルファベット・数字、または _ のみ使用可能です。',
	'FIELD_INVALID_CHARS_LETTER_NUM_DOTS'	=> 'フィールド “%s” の値は無効です。文字・数字、または . のみ使用可能です。',
	'FIELD_INVALID_CHARS_LETTER_NUM_ONLY'	=> 'フィールド “%s” の値は無効です。文字・数字のみ使用可能です。',
	'FIELD_INVALID_CHARS_LETTER_NUM_PUNCTUATION'	=> 'フィールド “%s” の値は無効です。文字・数字、または _,-. のみ使用可能で、先頭の文字はアルファベットにする必要があります。',
	'FIELD_INVALID_CHARS_LETTER_NUM_SPACERS'		=> 'フィールド “%s” の値は無効です。文字・数字・スペース、または -+_[] のみ使用可能です。',
	'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'		=> 'フィールド “%s” の値は無効です。文字・数字、または _ のみ使用可能です。',
	'FIELD_INVALID_DATE'				=> 'フィールド “%s” の値は正しい日付フォーマットではありません',
	'FIELD_INVALID_URL'					=> 'フィールド “%s” の値は正しいURLフォーマットではありません',
	...
	'GRAVATAR_AVATAR_EMAIL'			=> 'Gravatar メールアドレス',
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> '<a href="http://www.gravatar.com/">Gravatar</a>にアカウント登録しているメールアドレスを入力してください',
	'GRAVATAR_AVATAR_SIZE'			=> 'アバターサイズ',
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'アバター画像の横幅と高さを指定してください。自動検証にする場合は空欄にしてください。',
	...
	'INVALID_EMOJIS_USERNAME'	=> 'ユーザー名に禁止文字が含まれています（絵文字）',
	...
	'LOGIN_LINK'				=> '掲示板アカウントに連携するために外部サービスで使用中のアカウントをリンクまたは登録してください',
	'LOGIN_LINK_EXPLAIN'			=> 'この掲示板のアカウントと連携していない外部サービスにログインしようとしています。このアカウントとリンクするか、新規アカウントを作成してください。',
	'LOGIN_LINK_MISSING_DATA'		=> 'アカウントにリンクするために必要な外部サービスのデータが有効ではありません。ログインからやり直してください。',
	'LOGIN_LINK_NO_DATA_PROVIDED'		=> 'フォーラムアカウントにリンクするための外部アカウントデータが提供されていません。問題に対処したい場合は管理人に連絡してください。',
	'LOGIN_KEY'				=> 'ログインキー',
	'LOGIN_TIME'				=> 'ログイン時間',
	...
	'MESSAGE_REPORTED_MESSAGE'		=> '通報されたメッセージ',
	'MESSAGE_SENT_ON'				=> 'on',
	...
	'MOVE_PM_ERROR'					=> array(
		1	=> 'メッセージを新しいフォルダに移動している最中にエラーが発生しました。全 %1$s 件の内 %2$d 件のメッセージの移動を完了しています。',
	),
	...
	'NOTIFICATIONS_MARK_ALL_READ'					=> '全ての通知を既読にする',
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'				=> '全ての通知を既読にしてもよろしいですか？',
	'NOTIFICATIONS_MARK_ALL_READ_SUCCESS'				=> '全てのメッセージを既読にしました',
	'NOTIFICATION_GROUP_MISCELLANEOUS'				=> '雑多な通知',
	'NOTIFICATION_GROUP_MODERATION'					=> '通知のモデレート',
	'NOTIFICATION_GROUP_ADMINISTRATION'				=> '通知の管理',
	'NOTIFICATION_GROUP_POSTING'					=> '通知の投稿',
	'NOTIFICATION_METHOD_BOARD'					=> '通知',
	'NOTIFICATION_METHOD_EMAIL'					=> 'Eメール',
	'NOTIFICATION_METHOD_JABBER'					=> 'Jabber',
	'NOTIFICATION_TYPE'						=> '通知のタイプ',
	'NOTIFICATION_TYPE_BOOKMARK'					=> 'ブックマークしているトピックに返信がありました',
	'NOTIFICATION_TYPE_GROUP_REQUEST'				=> 'あなたがリーダーを務めているグループに加入リクエストがありました',
	'NOTIFICATION_TYPE_FORUM'							=> '購読中のフォーラム内のトピックに返信がありました',
	'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'				=> '記事またはトピックには承認が必要です',
	'NOTIFICATION_TYPE_MODERATION_QUEUE'				=> 'トピック／記事にモデレーターの承認／不承認がありました',
	'NOTIFICATION_TYPE_PM'						=> 'プライベートメッセージが届きました',
	'NOTIFICATION_TYPE_POST'					=> '購読中のトピックに返信がありました',
	'NOTIFICATION_TYPE_QUOTE'					=> '記事が引用されました',
	'NOTIFICATION_TYPE_REPORT'					=> '記事が通報されました',
	'NOTIFICATION_TYPE_REPORT_CLOSED'					=> 'あなたの通報（記事）はモデレーターによって審査が完了しました',
	'NOTIFICATION_TYPE_REPORT_PM'						=> 'プライベートメッセージが通報されました',
	'NOTIFICATION_TYPE_REPORT_PM_CLOSED'				=> 'あなたの通報（PM）はモデレーターによって審査が完了しました',
	'NOTIFICATION_TYPE_TOPIC'					=> '購読中のフォーラムに新規トピックが作成されました',
	'NOTIFICATION_TYPE_ADMIN_ACTIVATE_USER'				=> 'アカウント有効化の必要なユーザー',
	'NOTIFICATION_TYPE_UPDATE_MAINTENANCE'				=> 'phpBB のアップデート通知',
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1	=> 'フォルダが満杯のため、%d 件のプライベートメッセージが待機状態にあります',
	),
	'NO_ACTION_MODE'				=> 'アクションが指定されていません',
	'NO_AUTHOR'					=> '送信者が指定されていません',
	'NO_AVATAR'					=> 'アバターが選択されていません',
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'プライベートメッセージを印刷するにはパーミッションが必要です',
	'NO_AUTH_PROFILEINFO'			=> 'プロフィール情報を変更するにはパーミッションが必要です',
	...
	'EMAIL_NOT_UNIQUE'			=> '指定されたメールアドレスは複数のユーザに使用されています。ユーザー名も指定してください。',
	...
	'NO_RESET_TOKEN'			=> 'パスワードリセットトークンを提供していません',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'パスワードは少なくとも %1$s 字以上にする必要があります。大文字アルファベットと小文字アルファベット、さらに数字を含めてください。',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'パスワードは少なくとも %1$s 字以上にする必要があります',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'パスワードは少なくとも %1$s 字以上にする必要があります。大文字アルファベットと小文字アルファベットを含めてください。',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'パスワードは少なくとも %1$s 字以上にする必要があります。大文字アルファベットと小文字アルファベット、さらに数字と記号を含めてください。',
	'PASSWORD'					=> 'パスワード',
	'PASSWORD_ACTIVATED'		=> '新しいパスワードは有効化されました',
	'PASSWORD_RESET'			=> 'パスワードは正常にリセットされました',
	'PASSWORD_RESET_LINK_SENT'	=> 'アカウントが存在しているならば、パスワードリセットリンクが登録済みのメールアドレスに送信されました。 メールが届かない場合は、アカウントが禁止されているか、アカウントがアクティブになっていないか、短い期間内に複数のパスワードのリセットを要求したか、パスワードの変更が許可されていない可能性があります。これらの理由のいずれかが該当する場合は、管理者に連絡してください。また、スパムフィルターを確認してください。',
	...
	'PM_ICON'					=> 'PMアイコン',
	'PM_INBOX'					=> '受信ボックス',
	'PM_MARK_ALL_READ'			=> '全てのメッセージを既読にする',
	'PM_MARK_ALL_READ_SUCCESS'		=> 'フォルダ内の全てのメッセージを既読にしました',
	...
	'PM_TO'						=> 'メッセージ送信',
	'PM_TOOLS'					=> 'メッセージツール',
	'PM_USERS_REMOVED_NO_PERMISSION'	=> 'プライベートメッセージの閲覧権限がないため、追加できなかったユーザーがあります。',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> '"自動ログインを有効にする" のログインキーは自動ログインの際に取得されたログです。あなたがログアウトすれば、ログアウトに使用したPCのログインキーのみ削除されます。他の端末でこのサイトにログインしたときは、別のログインキーが生成されます。',
	'PROFILE_NO_AUTOLOGIN_KEYS'	=> '"自動ログインを有効にする" ログインキーは保存されていません',

	'RECIPIENT'					=> '受取人',
	'RECIPIENTS'					=> '受取人',
	'REGISTRATION'					=> 'ユーザー登録',
	'OAUTH_REGISTRATION'				=> '外部サービスを使っての登録',
	...
	'RESET_TOKEN_EXPIRED_OR_INVALID'	=> '指定したパスワードリセットトークンは無効であるか、有効期限が切れています',
	...
	'TIMEZONE'				=> 'タイムゾーン',
	'TIMEZONE_DATE_SUGGESTION'		=> 'タイムゾーンの提案: %s',
	'TIMEZONE_INVALID'			=> '選択したタイムゾーンは有効ではありません',
	'TO'					=> '受取人',
	'TO_MASS'				=> '受取人',
	'TO_ADD'				=> '受取人を追加',
	'TO_ADD_MASS'				=> '受取人を追加',
	'TO_ADD_GROUPS'				=> 'グループを追加',
	...
	'UCP_AUTH_LINK_ASK'			=> 'この外部サービスと連携するアカウントを持っていません。このサービスと掲示板アカウントをリンクするために下のボタンをクリックしてください。',
	'UCP_AUTH_LINK_ID'			=> '一意の識別名',
	'UCP_AUTH_LINK_LINK'			=> 'リンク',
	'UCP_AUTH_LINK_MANAGE'			=> '外部アカウント連携の管理',
	'UCP_AUTH_LINK_NOT_SUPPORTED'		=> '現在の承認方法は掲示板アカウントを外部サービスとリンクする機能をサポートしていません。',
	'UCP_AUTH_LINK_TITLE'			=> '外部アカウント連携の管理',
	'UCP_AUTH_LINK_UNLINK'			=> 'リンク解除',
	...
	'UCP_NOTIFICATION_LIST_EXPLAIN'		=> '過去の通知の一覧を参照できます',
	'UCP_NOTIFICATION_OPTIONS'		=> '通知オプションの管理',
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'お好みの掲示板通知方法を設定できます',
	...
	'UCP_PROFILE_AUTOLOGIN_KEYS'		=> '“自動ログインを有効にする”ログインキーの管理',

	'UCP_USERGROUPS'			=> 'グループ',
	'UCP_USERGROUPS_MEMBER'			=> 'メンバーの管理',
	'UCP_USERGROUPS_MANAGE'			=> 'グループの管理',

	'UCP_PASSWORD_RESET_DISABLED'		=> 'パスワードリセット機能はユーザーに提供されていません。アクセスの際にお手伝いが必要であれば %s管理人%s にご連絡ください。',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'		=> 'ユーザー名は %1$s 以上 %2$s 以下にする必要があります。アルファベットと数字のみ使用できます。',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'	=> 'ユーザー名は %1$s 以上 %2$s 以下にする必要があります。アルファベット、数字、半角スペース、記号 -+_[] のみ使用できます。',
	'USERNAME_ASCII_EXPLAIN'		=> 'ユーザー名は %1$s 以上 %2$s 以下にする必要があります。ASCII文字 （半角英数字、限られた記号） のみ使用できます。特殊な記号は使用できません。',
	'USERNAME_LETTER_NUM_EXPLAIN'		=> 'ユーザー名は %1$s 以上 %2$s 以下にする必要があります。ラテン系文字と数字のみ使用できます。特殊な記号は使用できません。',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'	=> 'ユーザー名は %1$s 以上 %2$s 以下にする必要があります。ラテン系文字、数字、半角スペース、記号 -+_[] のみ使用できます。特殊な記号は使用できません。',
